...
void create_arp_response(struct sr_arpreq* , struct sr_instance* );
int send_arp_req(struct sr_instance*, char*, unsigned char*, uint32_t, uint32_t );
void sr_handle_arpreq(struct sr_instance* , struct sr_arpreq* );
void clean_arpcache(struct sr_arpcache* );
